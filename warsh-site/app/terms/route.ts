...
<body>
  <div class="container">
    ...
    <p>Chat messages with Ustaad Noor are retained while your Warsh account is active so the visible conversation can continue across sessions. They are used to deliver and maintain the tutoring service and are deleted with your Warsh account, subject to the limited retention described in the Privacy Policy.</p>
    ...
    <p>You may delete your account at any time from within the app (Settings &rarr; Account &rarr; Delete account) or use the external deletion resource linked in our Privacy Policy. Deleting your Warsh account removes its associated Warsh database records. Limited security, fraud-prevention, transaction, backup, or legal records may be retained where reasonably necessary or required by law, as described in the Privacy Policy. Your subscription will continue on your app store account until you cancel it separately.</p>

...
const styles = StyleSheet.create({
  ...
  pillText: { fontFamily: Fonts.bold, fontSize: 11, letterSpacing: 0.4, color: WarshPalette.goldText },
  ...
  modelLabel: { fontFamily: Fonts.bold, fontSize: 10, letterSpacing: 0.4, color: WarshPalette.goldText },

...
const styles = StyleSheet.create({
  ...
  pill: { paddingHorizontal: 11, paddingVertical: 6, borderRadius: Radii.lg, backgroundColor: WarshPalette.parchmentBg },
  pillDone: { backgroundColor: WarshPalette.correctBg },
  pillText: { fontFamily: Fonts.bold, fontSize: 11, letterSpacing: 0.4, color: WarshPalette.goldDeep },
  pillTextDone: { color: WarshPalette.sageDeep },
  turnCount: { fontFamily: Fonts.bold, fontSize: 11, color: WarshPalette.subtleBrown },
  ...
  avatarText: { fontFamily: Fonts.bold, fontSize: 11, color: WarshPalette.sageDeep },
  bubble: { maxWidth: "78%", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 16, borderWidth: 1, gap: 4 },
  ...
  meaning: { fontFamily: Fonts.regular, fontSize: 11, color: WarshPalette.subtleBrown },
  ...
  cueText: { flex: 1, fontFamily: Fonts.regular, fontSize: 11, color: WarshPalette.bodyBrown },
  ...
  slotText: { fontFamily: Fonts.bold, fontSize: 14, color: WarshPalette.goldDeep },
  ...
  wordOpen: { color: WarshPalette.goldDeep },
  ...
  verdict: { fontFamily: Fonts.bold, fontSize: 11 },
  verdictGood: { color: WarshPalette.sageDeep },
  verdictBad: { color: WarshPalette.wrongText },
  tip: { fontFamily: Fonts.regular, fontSize: 11, lineHeight: 16, color: WarshPalette.bodyBrown },
  modelBubble: { backgroundColor: WarshPalette.white, borderColor: WarshPalette.gold, alignItems: "flex-end" },
  modelLabel: { fontFamily: Fonts.bold, fontSize: 10, letterSpacing: 0.4, color: WarshPalette.goldDeep },
  ...
  actionText: { fontFamily: Fonts.bold, fontSize: 12, color: WarshPalette.goldDeep },
  ...
  noteText: { flexShrink: 1, fontFamily: Fonts.regular, fontSize: 11, lineHeight: 16, color: WarshPalette.ink },
  ...
  skipText: { fontFamily: Fonts.bold, fontSize: 13, color: WarshPalette.goldDeep },
});

...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: Radii.md, borderWidth: 1, borderColor: WarshPalette.sageSoft, backgroundColor: WarshPalette.white },
  ...
  cueCard: { flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 12, paddingVertical: 10, borderRadius: Radii.md, backgroundColor: WarshPalette.parchmentDeep },
  ...
  optionList: { gap: 10 },
  option: { minHeight: 56, alignItems: "center", justifyContent: "center", paddingHorizontal: 14, borderRadius: Radii.md, borderWidth: 1, borderColor: WarshPalette.sageSoft, backgroundColor: WarshPalette.white },
  ...
  slot: { minWidth: 60, height: 40, alignItems: "center", justifyContent: "center", paddingHorizontal: 10, borderRadius: Radii.md, borderWidth: 1.5, borderColor: WarshPalette.parchment, borderStyle: "dashed" },
  ...
  tile: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: Radii.md, borderWidth: 1, borderColor: WarshPalette.sageSoft, backgroundColor: WarshPalette.white },
  ...
  feedback: { flexDirection: "row", alignItems: "center", gap: 10, padding: 12, borderRadius: Radii.md },

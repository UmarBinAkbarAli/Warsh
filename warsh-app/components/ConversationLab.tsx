...
const styles = StyleSheet.create({
  ...
  pillText: { fontFamily: Fonts.bold, fontSize: 11, color: WarshPalette.goldDeep, letterSpacing: 0.4 },
  ...
  sectionLabel: { fontFamily: Fonts.bold, fontSize: FontSizes.label, letterSpacing: 0.6, color: WarshPalette.goldDeep },
